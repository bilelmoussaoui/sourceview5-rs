...
impl<O: IsA<CompletionCell>> CompletionCellExt for O {
    fn get_column(&self) -> CompletionColumn {
        unsafe {
            from_glib(gtk_source_sys::gtk_source_completion_cell_get_column(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn get_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            from_glib_none(gtk_source_sys::gtk_source_completion_cell_get_widget(self.as_ref().to_glib_none().0))
        }
    }

    fn set_gicon<P: IsA<gio::Icon>>(&self, gicon: &P) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_gicon(self.as_ref().to_glib_none().0, gicon.as_ref().to_glib_none().0);
        }
    }

    fn set_icon_name(&self, icon_name: &str) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_icon_name(self.as_ref().to_glib_none().0, icon_name.to_glib_none().0);
        }
    }

    fn set_markup(&self, markup: &str) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_markup(self.as_ref().to_glib_none().0, markup.to_glib_none().0);
        }
    }

    fn set_paintable<P: IsA<gdk::Paintable>>(&self, paintable: &P) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_paintable(self.as_ref().to_glib_none().0, paintable.as_ref().to_glib_none().0);
        }
    }

    fn set_text(&self, text: &str) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_text(self.as_ref().to_glib_none().0, text.to_glib_none().0);
        }
    }
    ...
    fn set_widget<P: IsA<gtk::Widget>>(&self, child: &P) {
        unsafe {
            gtk_source_sys::gtk_source_completion_cell_set_widget(self.as_ref().to_glib_none().0, child.as_ref().to_glib_none().0);
        }
    }
    ...
    fn get_property_widget(&self) -> Option<gtk::Widget> {
        unsafe {
            ...
            gobject_sys::g_object_get_property(self.to_glib_none().0 as *mut gobject_sys::GObject, b"widget\0".as_ptr() as *const _, value.to_glib_none_mut().0);
            value.get().expect("Return Value for property `widget` getter")
        }
    }

    fn connect_property_markup_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_markup_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletionCell, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CompletionCell>
        {
    ...
    fn connect_property_paintable_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_paintable_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletionCell, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CompletionCell>
        {
            let f: &F = &*(f as *const F);
            f(&CompletionCell::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_text_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_text_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletionCell, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CompletionCell>
        {
            let f: &F = &*(f as *const F);
            f(&CompletionCell::from_glib_borrow(this).unsafe_cast_ref())
    ...
    fn connect_property_widget_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_widget_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceCompletionCell, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<CompletionCell>
        {
            let f: &F = &*(f as *const F);
            f(&CompletionCell::from_glib_borrow(this).unsafe_cast_ref())
        ...
        unsafe {
            ...
            connect_raw(self.as_ptr() as *mut _, b"notify::widget\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_widget_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
}

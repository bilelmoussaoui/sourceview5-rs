...
pub trait ViewExt: 'static {
    ...
    fn connect_line_mark_activated<F: Fn(&Self, &gtk::TextIter, u32, gdk::ModifierType, i32) + 'static>(&self, f: F) -> SignalHandlerId;
    ...
    #[cfg(any(feature = "v5_0", feature = "dox"))]
    fn connect_property_enable_snippets_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId;
...
impl<O: IsA<View>> ViewExt for O {
    ...
    fn get_enable_snippets(&self) -> bool {
        unsafe {
            from_glib(gtk_source_sys::gtk_source_view_get_enable_snippets(self.as_ref().to_glib_none().0))
        }
    }
    ...
    fn push_snippet<P: IsA<Snippet>>(&self, snippet: &P, location: Option<&mut gtk::TextIter>) {
        unsafe {
            gtk_source_sys::gtk_source_view_push_snippet(self.as_ref().to_glib_none().0, snippet.as_ref().to_glib_none().0, location.to_glib_none_mut().0);
        }
    }
    ...
    fn set_enable_snippets(&self, enable_snippets: bool) {
        unsafe {
            gtk_source_sys::gtk_source_view_set_enable_snippets(self.as_ref().to_glib_none().0, enable_snippets.to_glib());
        }
    }
    ...
    fn connect_line_mark_activated<F: Fn(&Self, &gtk::TextIter, u32, gdk::ModifierType, i32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn line_mark_activated_trampoline<P, F: Fn(&P, &gtk::TextIter, u32, gdk::ModifierType, i32) + 'static>(this: *mut gtk_source_sys::GtkSourceView, iter: *mut gtk_sys::GtkTextIter, button: libc::c_uint, state: gdk_sys::GdkModifierType, n_presses: libc::c_int, f: glib_sys::gpointer)
            where P: IsA<View>
        {
            let f: &F = &*(f as *const F);
            f(&View::from_glib_borrow(this).unsafe_cast_ref(), &from_glib_borrow(iter), button, from_glib(state), n_presses)
        }
        unsafe {
            let f: Box_<F> = Box_::new(f);
    ...
    #[cfg(any(feature = "v5_0", feature = "dox"))]
    fn connect_property_enable_snippets_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_enable_snippets_trampoline<P, F: Fn(&P) + 'static>(this: *mut gtk_source_sys::GtkSourceView, _param_spec: glib_sys::gpointer, f: glib_sys::gpointer)
            where P: IsA<View>
        {
            let f: &F = &*(f as *const F);
            f(&View::from_glib_borrow(this).unsafe_cast_ref())
        ...
        unsafe {
            let f: Box_<F> = Box_::new(f);
            connect_raw(self.as_ptr() as *mut _, b"notify::enable-snippets\0".as_ptr() as *const _,
                Some(transmute::<_, unsafe extern "C" fn()>(notify_enable_snippets_trampoline::<Self, F> as *const ())), Box_::into_raw(f))
        }
    }
